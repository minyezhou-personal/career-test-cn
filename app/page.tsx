...
export default function Home() {
  ...
  const calculateResult = (finalAnswers: { [key: number]: number }) => {
    ...
    const weights: Record<number, Partial<Record<keyof typeof careerPaths, number>>> = {
      // 技术专家
      1: { '技术专家': 1.4, '产品技术': 0.6, '学术研究': 0.4 },
      2: { '技术专家': 1.1, '独立创业': 0.8, '产品技术': 0.6, '学术研究': 0.4 },
      6: { '技术专家': 1.0, '学术研究': 0.9 },
      10: { '技术专家': 1.0, '学术研究': 0.8 },
      17: { '技术专家': 1.1, '产品技术': 0.5, '学术研究': 0.9 },
      28: { '技术专家': 1.2, '学术研究': 0.7 },
      ...
      // 教育培训
      8: { '教育培训': 1.3, '技术管理': 0.4 },
      13: { '教育培训': 0.8, '产品技术': 0.4, '学术研究': 0.6 },
      11: { '教育培训': 0.6, '学术研究': 0.4 },
    };
