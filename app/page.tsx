...
const careerPaths = {
  ...
  '学术研究': {
    description: '你适合做长期研究与深度探索，产出论文/成果并持续积累学术影响力',
    careers: ['读博/博士后', '高校研究岗', '研究院科研岗', '实验室研究员'],
    skills: ['研究方法', '实验/验证', '学术写作', '长期专注'],
  },
  '独立创业': {
...
export default function Home() {
  ...
  const calculateResult = (finalAnswers: { [key: number]: number }) => {
    ...
    // 每道题对不同路径的“加权贡献”（正负都可能）：
    // - 使用中心化分数（score-3，范围 -2..+2）后，负权重代表“越同意越不适合该方向”。
    // - 这样每题都会产生区分度，而不是“全都加分”。
    const weights: Record<number, Partial<Record<keyof typeof careerPaths, number>>> = {
      1: { '技术专家': 1.4, '产品技术': 0.4, '学术研究': 0.6, '技术管理': 0.2 },
      2: { '技术专家': 1.1, '学术研究': 0.7, '独立创业': 0.5, '产品技术': 0.2 },
      3: { '产品技术': 0.8, '教育培训': 0.8, '技术管理': 0.5, '技术专家': 0.2 },
      4: { '技术管理': 1.3, '独立创业': 0.4, '产品技术': 0.3, '技术专家': -0.2, '学术研究': -0.3 },
      5: { '技术管理': 1.1, '产品技术': 0.6, '教育培训': 0.3, '独立创业': 0.2 },
      6: { '学术研究': 1.0, '技术专家': 0.8, '独立创业': 0.3 },
      7: { '产品技术': 1.2, '独立创业': 0.6, '技术管理': 0.3, '学术研究': -0.4 },
      8: { '教育培训': 1.4, '技术管理': 0.5, '产品技术': 0.3 },
      9: { '独立创业': 1.3, '产品技术': 0.5, '技术管理': 0.4, '学术研究': -0.4 },
      10: { '技术专家': 1.0, '学术研究': 0.9, '独立创业': 0.3, '技术管理': -0.5, '产品技术': -0.3, '教育培训': -0.2 },

      11: { '教育培训': 0.5, '学术研究': 0.4, '产品技术': 0.2, '技术专家': 0.2, '独立创业': -0.7, '技术管理': -0.4 },
      12: { '独立创业': 0.7, '技术管理': 0.6, '产品技术': 0.3, '学术研究': -0.3, '教育培训': -0.5 },
      13: { '教育培训': 0.6, '学术研究': 0.5, '产品技术': 0.4, '独立创业': 0.2 },
      14: { '教育培训': 0.6, '学术研究': 0.5, '技术管理': 0.4, '产品技术': 0.2, '独立创业': -0.8 },
      15: { '独立创业': 0.6, '产品技术': 0.7, '技术专家': 0.5, '学术研究': 0.4 },

      16: { '产品技术': 1.0, '技术管理': 0.7, '独立创业': 0.4, '技术专家': 0.3 },
      17: { '学术研究': 0.9, '技术专家': 0.8, '产品技术': 0.6, '技术管理': 0.4 },
      18: { '独立创业': 1.1, '产品技术': 0.8, '技术专家': 0.4, '学术研究': 0.3 },
      19: { '技术管理': 1.1, '产品技术': 0.7, '独立创业': 0.4, '学术研究': -0.2 },
      20: { '独立创业': 1.0, '技术管理': 0.5, '产品技术': 0.3, '学术研究': -0.3, '教育培训': -0.2 },

      21: { '产品技术': 1.0, '独立创业': 0.6, '技术管理': 0.4, '学术研究': -0.3, '技术专家': -0.2 },
      22: { '产品技术': 0.8, '教育培训': 0.6, '学术研究': 0.6, '技术管理': 0.4, '技术专家': 0.2 },
      23: { '产品技术': 0.8, '教育培训': 0.8, '技术管理': 0.6, '独立创业': 0.3, '技术专家': -0.7, '学术研究': -0.8 },
      24: { '独立创业': 0.9, '产品技术': 0.8, '技术管理': 0.3, '学术研究': -0.3 },
      25: { '技术管理': 0.8, '产品技术': 0.8, '技术专家': 0.3, '独立创业': 0.2 },

      26: { '独立创业': 0.7, '产品技术': 0.6, '技术管理': 0.4, '学术研究': -0.2, '教育培训': -0.2 },
      27: { '产品技术': 0.5, '独立创业': 0.4, '技术管理': 0.3, '学术研究': -0.6 },
      28: { '技术专家': 1.2, '学术研究': 0.9, '产品技术': -0.4, '技术管理': -0.4, '独立创业': -0.3 },
      29: { '独立创业': 1.0, '技术专家': 0.4, '教育培训': 0.2, '技术管理': -0.6 },
      30: { '独立创业': 0.8, '技术管理': 0.6, '技术专家': 0.4, '产品技术': 0.3, '教育培训': -0.2 },

      31: { '学术研究': 1.3, '技术专家': 0.4, '产品技术': -0.3, '独立创业': -0.4 },
      32: { '学术研究': 1.2, '技术专家': 0.4, '产品技术': -0.2, '独立创业': -0.3 },
      33: { '学术研究': 1.1, '教育培训': 0.4, '产品技术': -0.2, '独立创业': -0.3 },
    };
    ...
    for (const [qidStr, score] of Object.entries(finalAnswers)) {
      ...
      // 将 1-5 分中心化到 -2..+2，增强区分度（某些题会对某些方向产生负贡献）
      const centered = score - 3;

      for (const [path, weight] of Object.entries(w)) {
        const ww = weight || 0;
        scores[path] += centered * ww;
        denom[path] += Math.abs(ww);
      }
    }

    // 归一化：避免“某个方向权重题更多”导致结果永远偏向它
    // 归一化后分数通常落在 -2..+2，数值越高代表匹配度越强
  ...
  const reportTemplates: Record<string, {
    ...
    '学术研究': {
      core: '你更适合走“提出问题 → 设计方法 → 长周期验证 → 产出成果”的路径。你对探索未知更有耐心，愿意投入时间做严谨验证，并通过论文/项目/研究成果建立长期影响力。',
      strengths: ['研究动机更强：愿意长期深挖一个问题', '更擅长严谨验证（实验/对照/复现/数据）', '适合在不确定中持续推进并沉淀成果'],
      strongFit: ['读博/申博（明确方向）', '高校/研究院科研岗', '实验室研究助理/研究型实习'],
      nextFit: ['企业 R&D/研究支持岗（偏工程化）', '技术专家（把研究能力转成工程影响）'],
      risk: ['研究路径回报周期长：需要你对不确定性有心理预期', '如果只是“想逃避就业”，读博可能会放大焦虑（建议先确认研究问题/导师/资源）'],
      nextSteps: ['把研究方向写成一句话：我研究什么问题、为什么重要、用什么方法', '准备 1 个可展示的研究产出：论文/预印本/复现报告/开源代码/研究笔记', '提前联系导师/实验室：用 1 页研究兴趣 + 代表作降低沟通成本'],
    },
    '独立创业': {
      ...
      <div className="card">
        ...
        <div className="result-content">
          ...
          <div className="result-section">
            ...
            <p className="muted">说明：分数已做归一化（大致范围 -2..+2），用于对比不同方向的相对匹配程度。</p>
          </div>
